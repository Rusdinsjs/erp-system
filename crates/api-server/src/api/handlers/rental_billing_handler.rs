...
use management_system_core::application::dto::rental_dto::{
    BillingCreateRequest, BillingPreviewRequest,
};
use management_system_core::domain::entities::UserClaims; // Fixed imports
