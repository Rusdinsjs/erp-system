    ...
    '{
        ...
        "modules": [
            ...
            },
            {
                ...
                "defaultRoute": "/assets",
                "minLevel": 5,
                "features": ["Asset Registry", "Lifecycle", "Categories & Locations"],
                "menuIds": ["assets", "asset-lifecycle", "categories", "locations", "asset-audit"],
                "order": 2,
                "enabled": true
            },
            {
            ...
            },
            {
                ...
                "minLevel": 4,
                "features": ["Rental Operations", "Contracts", "Client Management"],
                "menuIds": ["rentals", "contracts", "contract-templates", "sales-invoices", "clients", "loans"],
                "order": 4,
                "enabled": true
            },
            {
                ...
                "minLevel": 3,
                "features": ["Inventory Control", "Stock Opname", "Vendor Bills"],
                "menuIds": ["inventory-items", "inventory-categories", "stock-opname", "purchase-bills", "conversions"],
                "order": 5,
                "enabled": true
            },
            {
