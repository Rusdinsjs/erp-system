...
-- Description: Creates schemas for HR, CRM, Rental, Inventory, Commercial and moves tables.
-- Created: 2026-08-08
...
BEGIN
    ...
    END IF;
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'face_photos') THEN
    ...
    END IF;
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'employee_evaluations') THEN
...
DO $$
BEGIN
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'rentals') THEN
    ...
    END IF;
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'rental_billings') THEN
        ALTER TABLE public.rental_billings SET SCHEMA rental;
    END IF;
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'rental_timesheets') THEN
        ALTER TABLE public.rental_timesheets SET SCHEMA rental;
    END IF;
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'contract_approvals') THEN
        ALTER TABLE public.contract_approvals SET SCHEMA rental;
    END IF;
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'contract_documents') THEN
        ALTER TABLE public.contract_documents SET SCHEMA rental;
    END IF;
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'contract_renewals') THEN
...
DO $$
BEGIN
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'inventory_categories') THEN
    ...
    END IF;
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'inventory_documents') THEN
