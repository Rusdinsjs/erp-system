-- Migration: Add Organization module to launchpad_config
-- Replaces the stored launchpad_config with the updated version that includes:
--   - New "Organization" module (company, departments, branch, users, roles, email-account)
--   - Department moved from HR to Organization
--   - Users & Roles moved from Admin to Organization
--   - All module orders updated accordingly
