...
export function AssetFinancials({ maintenanceCost, rentalIncome, purchasePrice }: AssetFinancialsProps) {
    ...
    return (
        <Card className="p-0 overflow-hidden border-slate-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-slate-800 text-center">

                {/* Maintenance Section */}
                <div className="p-6 bg-slate-900/20 grouped-stat">
                    <div className="flex flex-col items-center">
                        <div className="p-2 rounded-full bg-red-500/10 mb-3">
                            <TrendingDown size={20} className="text-red-400" />
                        </div>
                        <span className="text-sm text-slate-400 mb-1">Total Maintenance Cost</span>
                ...
                <div className="p-6 bg-slate-900/20 grouped-stat">
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-sm text-slate-400 mb-1">Total Rental Income</span>
                        <span className="text-xl font-bold text-white tracking-tight">
                ...
                <div className={`p-6 ${isProfitable ? 'bg-green-500/5' : 'bg-red-500/5'} grouped-stat`}>
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-sm text-slate-400 mb-1">Net Operational Profit</span>
