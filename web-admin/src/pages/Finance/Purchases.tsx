        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Kelola tagihan supplier dan pesanan pembelian Anda</p>
                </div>
                    ...
                    <div className="flex gap-2 items-center flex-1 min-w-[300px]">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full bg-background border border-border rounded-lg pl-10 pr-4 py-2 text-sm text-foreground focus:outline-none focus:border-rose-500/50 transition-all"
                                value={searchTerm}
